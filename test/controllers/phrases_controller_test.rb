...
class PhrasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phrase" do
    assert_difference('Phrase.count') do
      post phrases_url, params: { phrase: { email: @phrase.email, first_name: @phrase.first_name, last_name: @phrase.last_name, slogan: @phrase.slogan } }, as: :json
    end
  ...
  test "should update phrase" do
    patch phrase_url(@phrase), params: { phrase: { email: @phrase.email, first_name: @phrase.first_name, last_name: @phrase.last_name, slogan: @phrase.slogan } }, as: :json
    assert_response 200
  end
